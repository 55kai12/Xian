...
object LockMachineOverlayController {
    ...
    private val tickRunnable = object : Runnable {
        override fun run() {
            ...
            view.findViewById<TextView>(R.id.remainingText).text =
                LockMachineController.remainingText(context)
    ...
    fun show(context: Context) {
        ...
        val view = LayoutInflater.from(applicationContext).inflate(R.layout.overlay_lock_machine, null, false)
    ...
    private fun updateContent(context: Context) {
        val view = overlayView ?: return
        view.findViewById<TextView>(R.id.remainingText).text = LockMachineController.remainingText(context)
