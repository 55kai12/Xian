...
**当前版本** `v2.0.64`（versionCode 264） · **最低系统** Android 8.0（API 26） · **目标系统** Android 15（API 35）
...
<table>
  <tr>
    <td align="center"><img src="screenshots/01-tasks.png" width="190" /><br /><sub><b>任务清单</b><br />周视图 · 趋势线 · 倒数日</sub></td>
