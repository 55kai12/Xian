...
**当前版本** `v2.0.78`（versionCode 278） · **最低系统** Android 8.0（API 26） · **目标系统** Android 15（API 35）
...
| `SCHEDULE_EXACT_ALARM` | 定时锁机与到期提醒的精确闹钟。**未授予也能用**：自动退化成不精确闹钟、只晚几十秒；保存任务或锁机时段时会自动引导开启 |
